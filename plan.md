...
**Phase 4 is done. Next up: Phase 6 — Cross-cutting hardening** (see table above) — Phase 5 (frontend depth: profile/settings/search) remains partially open; both are candidates for the next session, ask the user which to prioritize rather than assuming.
